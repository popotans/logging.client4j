...
public abstract class LogSenderBase implements DequeueAction<ILogEntity> {
	     ...
	     protected TLogPackage CreateLogPackage(List<ILogEntity> logEntities)
	     {
	    	 ...
	    	 List<MetricEntity> metrics=new ArrayList<MetricEntity>();
	         ...
	         List<TLogEntity> tlogs = new ArrayList<TLogEntity>();
	         ...
	         List<TMetricEntity> tmetrics = new ArrayList<TMetricEntity>();
